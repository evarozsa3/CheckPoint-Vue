...
- "As a user, I can see all the blogs on the `home page`, so that I do not have to log in to see all the blogs" --DONE
- "As a user, I can click on a blog to be taken to the `blog page`, so that I can read the contents of the blog and its comments" --DONE
...
- [ DONE ] `Home page` displays all published blogs (response from a standard get request)
...
- [DONE] Users Can Register, Login, and Logout (this should work out of the box, don't break it)
